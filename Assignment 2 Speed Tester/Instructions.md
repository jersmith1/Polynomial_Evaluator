https://github.com/TheBigSasha/COMP250A2_SpeedTester
# Speed tester for COMP250 Assignment 2 @ McGill University!
Requires library https://github.com/TheBigSasha/RuntimeTester

Drag assignment2.SpeedTester.java into your project, same place as your assignment 2 files.

Import the library (see below)

Run assignment2.SpeedTester.java
...
## 💻 Usage
Add assignment2.SpeedTester.java and RuntimeTester-(your platform).jar to your project with assignment 2.
